...
class _WorkerDetailsScreenState extends State<WorkerDetailsScreen> {
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text("Worker Id : 11124", style: ColorAndFont.TITTLE_TEXT),
          Center(
            child: Padding(
                                  ...
                                  text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: "Electrition",
                                            style:
                                                ColorAndFont.Sm_TEXT_BOLD_GRAY),
                                      ]),
                                ),
                                IconButton(
                                    onPressed: () {},
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                                            const Color.fromARGB(255, 240, 10, 10),
                                      ),
                                      onPressed: () {
                                        openCheckout();
                                      },
          ...
          visibleTable2
              ...
              : const SizedBox(),
          visibleTable2
              ? Center(child: WorkerPreviousPaymentsTable(context: context))
              : const SizedBox(),
        ]),
      ),
    );
  ...
  DataTable WorkerPreviousPaymentsTable({required context}) {
    return DataTable(
      ...
      DataRow(cells: [
        ...
        DataCell(ElevatedButton(
          ...
          onPressed: () {
            showDialog(
                context: context,
                builder: (_) => const WorkerTransactionDetails());
          },
        )),
      ]),
      DataRow(cells: [
...
class WorkerTransactionDetails extends StatelessWidget {
  const WorkerTransactionDetails({super.key});
